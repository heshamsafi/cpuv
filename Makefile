...
pkgdatadir = $(datadir)/cpuv
pkgincludedir = $(includedir)/cpuv
pkglibdir = $(libdir)/cpuv
pkglibexecdir = $(libexecdir)/cpuv
...
bin_main_DEPENDENCIES = deps/libuv/out/Debug/obj.target/libuv.a
am__dirstamp = $(am__leading_dot)dirstamp
am_bin_test_fs_OBJECTS = test-fs.$(OBJEXT) $(am__objects_1)
bin_test_fs_OBJECTS = $(am_bin_test_fs_OBJECTS)
am__DEPENDENCIES_1 = deps/libuv/out/Debug/obj.target/libuv.a
...
PACKAGE_NAME = cpuv
PACKAGE_STRING = cpuv 0.1
PACKAGE_TARNAME = cpuv
PACKAGE_URL = 
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
SET_MAKE = 
...
DefaultLoop.o: src/DefaultLoop.cpp
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -MT DefaultLoop.o -MD -MP -MF $(DEPDIR)/DefaultLoop.Tpo -c -o DefaultLoop.o `test -f 'src/DefaultLoop.cpp' || echo '$(srcdir)/'`src/DefaultLoop.cpp
	$(am__mv) $(DEPDIR)/DefaultLoop.Tpo $(DEPDIR)/DefaultLoop.Po
#	source='src/DefaultLoop.cpp' object='DefaultLoop.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o DefaultLoop.o `test -f 'src/DefaultLoop.cpp' || echo '$(srcdir)/'`src/DefaultLoop.cpp

DefaultLoop.obj: src/DefaultLoop.cpp
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -MT DefaultLoop.obj -MD -MP -MF $(DEPDIR)/DefaultLoop.Tpo -c -o DefaultLoop.obj `if test -f 'src/DefaultLoop.cpp'; then $(CYGPATH_W) 'src/DefaultLoop.cpp'; else $(CYGPATH_W) '$(srcdir)/src/DefaultLoop.cpp'; fi`
	$(am__mv) $(DEPDIR)/DefaultLoop.Tpo $(DEPDIR)/DefaultLoop.Po
#	source='src/DefaultLoop.cpp' object='DefaultLoop.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o DefaultLoop.obj `if test -f 'src/DefaultLoop.cpp'; then $(CYGPATH_W) 'src/DefaultLoop.cpp'; else $(CYGPATH_W) '$(srcdir)/src/DefaultLoop.cpp'; fi`

FS.o: src/FS.cpp
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -MT FS.o -MD -MP -MF $(DEPDIR)/FS.Tpo -c -o FS.o `test -f 'src/FS.cpp' || echo '$(srcdir)/'`src/FS.cpp
	$(am__mv) $(DEPDIR)/FS.Tpo $(DEPDIR)/FS.Po
#	source='src/FS.cpp' object='FS.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o FS.o `test -f 'src/FS.cpp' || echo '$(srcdir)/'`src/FS.cpp

FS.obj: src/FS.cpp
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -MT FS.obj -MD -MP -MF $(DEPDIR)/FS.Tpo -c -o FS.obj `if test -f 'src/FS.cpp'; then $(CYGPATH_W) 'src/FS.cpp'; else $(CYGPATH_W) '$(srcdir)/src/FS.cpp'; fi`
	$(am__mv) $(DEPDIR)/FS.Tpo $(DEPDIR)/FS.Po
#	source='src/FS.cpp' object='FS.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
